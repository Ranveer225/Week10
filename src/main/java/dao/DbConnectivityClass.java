...
public class DbConnectivityClass {
    final static String DB_NAME="csc311semesterlong";
    MyLogger lg= new MyLogger();
    final static String SQL_SERVER_URL = "jdbc:mysql://csc311semesterlong.mysql.database.azure.com";//update this server name
    final static String DB_URL = "jdbc:mysql://csc311semesterlong.mysql.database.azure.com/"+DB_NAME;//update this database name
    final static String USERNAME = "singr12";// update this username
    final static String PASSWORD = "Farmingdale12.";// update this password
